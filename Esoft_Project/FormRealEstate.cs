        ...
        void ShowRealEstateSet()
        {
            ...
            foreach (RealEstateSet realEstate in Program.wftDb.RealEstateSet)
            {
                if (realEstate.Type == 0)
                {
                    ...
                    {
realEstate.Address_City, realEstate.Address_House, realEstate.Address_Street, realEstate.Address_House, realEstate.Coordinate_latitude.ToString(), realEstate.Coordinate_longitude.ToString(), realEstate.TotalArea.ToString(), realEstate.Rooms.ToString(), realEstate.Floor.ToString()
                    });
                    item.Tag = realEstate;
                ...
                {
                    ListViewItem item = new ListViewItem(new string[] {
                        realEstate.Address_City, realEstate.Address_House, realEstate.Address_Street, realEstate.Address_House, realEstate.Coordinate_latitude.ToString(), realEstate.Coordinate_longitude.ToString(), realEstate.TotalArea.ToString(), realEstate.TotalFloors.ToString()
                    });
                    item.Tag = realEstate;
