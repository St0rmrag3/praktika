...
namespace Esoft_Project
{
    public partial class FormSupply : Form
    {
        ...
        void ShowRealEstate()
        {
            ...
            {
                string[] item = { realEstateSet.Id.ToString() + ".", realEstateSet.Address_City + ",", realEstateSet.Address_Street + "Д.",
                    realEstateSet.Address_House + ",", "кв." + realEstateSet.Address_Number };
                ...
                ListViewItem item = new ListViewItem(new string[]
                    {
                        ...
                        supply.agent.LastName + " " + supply.agent.FirstName + " " + supply.agent.MiddleName,
                        ...
                        "г." + supply.RealEstateSet.Address_City + ", ул. " + supply.RealEstateSet.Address_Street + " , д. " + supply.RealEstateSet.Address_House
